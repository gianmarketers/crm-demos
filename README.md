...
| [`gohighlevel-showcase/index.html`](gohighlevel-showcase/index.html) | **GoHighLevel Demo Gallery** — a light-themed landing page (contrasting dark hero) that showcases all six niche demos below with their covers and links. The single page to send a GoHighLevel prospect. |
...
| [`gohighlevel-fitness/index.html`](gohighlevel-fitness/index.html) | **GoHighLevel Client Demo — Fitness/Gym** (Iron Pulse Fitness). Membership pipeline (→ Member Won), MRR & active-member KPIs, gym automations (missed-call text-back, free-trial→member, win-back lapsed), IG/FB lead sources. Ships with [`cover.png`](gohighlevel-fitness/cover.png). |
| [`gohighlevel-law-firm/index.html`](gohighlevel-law-firm/index.html) | **GoHighLevel Client Demo — Law Firm** (Hensley Law Group · personal injury). Intake pipeline (New Lead → Signed), case-value & cases-signed KPIs, legal automations (speed-to-lead intake, consult no-show recovery, post-settlement review/referral), LSA/Ads lead sources. Ships with [`cover.png`](gohighlevel-law-firm/cover.png). |
| [`gohighlevel-roofing-solar/index.html`](gohighlevel-roofing-solar/index.html) | **GoHighLevel Client Demo — Roofing & Solar** (Apex Roofing & Solar). Jobs pipeline (New Lead → Installed), storm-response blitz automation, estimate follow-up with financing, post-install review/referral, storm-map/LSA lead sources. Ships with [`cover.png`](gohighlevel-roofing-solar/cover.png). |
| [`gohighlevel-salon/index.html`](gohighlevel-salon/index.html) | **GoHighLevel Client Demo — Salon & Barber** (Velvet & Fade). Guest pipeline (New Lead → Regular), bookings/rebook-rate KPIs, salon automations (missed-call text-back, No-Show Shield, 6-week rebook), IG-first lead sources. Ships with [`cover.png`](gohighlevel-salon/cover.png). |
